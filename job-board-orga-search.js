...
let recordAppAcquiChannel = "recjNj27pMzDJ2NMx"; // La valeur de application Acquisition Channel
let paramsRedirect;
...
function pageLoad() {
  ...
  if (params.has("prescribing_organisation")) {
    ...
    orgaRecord = params.get("prescribing_organisation");
...
if (
  ...
  paramsRedirect =
    ...
    recordAppAcquiChannel +
    "&prescribing_organisation=" +
    orgaRecord; // Les params qu'on ajoute à l'URL, avec une variable
} else {
  paramsRedirect = "?application_creation_channel=" + recordAppAcquiChannel;
}
